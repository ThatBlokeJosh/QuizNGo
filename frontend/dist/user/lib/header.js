...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <a href="/" class="flex items-center m-0 p-0">
      <img src="../public/circle.png" class="h-8 rounded-full" alt="Circle" />
      <span class="text-2xl m-0 font-semibold whitespace-nowrap dark:text-white">QuizNGo</span>
  </a>
  <div class="flex md:order-2">
      <a href="/register">
      <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Get started</button></a>
  ...
  <div class="items-center hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
    <ul class="flex flex-cols justify-center font-medium p-4 md:p-0 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
      <li>
        <a href="#" class="block py-0 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page">Home</a>
      </li>
      <li>
